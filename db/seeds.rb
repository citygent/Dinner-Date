...
r1 = Restaurant.create(name: 'Thai Corner Cafe', description: 'Everything one looks for in a local restaurant: Lively, cheap and cosy, and it serves fantastic food.', address: 'North Cross Road', city: 'London', remote_picture_url: 'http://res.cloudinary.com/citygent/image/upload/v1442759284/Thai-Corner-Cafe-East-Dulwhich-Homegirl-London_dgut74.jpg')

r2 = Restaurant.create(name: 'Begging Bowl', description: 'Everything one looks for in a fancy restaurant: Busy yet chilled, with a brilliant kitchen team.', address: 'Belenden Road', city: 'London', remote_picture_url: 'http://res.cloudinary.com/citygent/image/upload/v1442759288/the-begging-bowl-16_nhlpg2.jpg')

r3 = Restaurant.create(name: 'Pizza Express', description: 'The popular pizza chain comes to Dulwich.', address: 'The Village, Dulwich Village', city: 'London', remote_picture_url: 'http://res.cloudinary.com/citygent/image/upload/v1442759308/IMG_1006-2_pdkfvu.jpg')

r4 = Restaurant.create(name: 'Firezza', description: 'Firezza opened in 2001 after its two owners realised a long held ambition to deliver quality Neapolitan pizza to discerning foodies.', address: 'Halfmoon Lane, Herne Hill', city: 'London', remote_picture_url: 'http://res.cloudinary.com/citygent/image/upload/v1442759306/IMG_3718_kt8cve.jpg')

r5 = Restaurant.create(name: 'Franklins', description: 'Restaurant serving seasonal British dishes made with Kent farm vegetables and rare-breed meats.', address: 'Lordship Lane, East Dulwich', city: 'London', remote_picture_url: 'http://res.cloudinary.com/citygent/image/upload/v1442759312/Franklins_kfwxyp.jpg')
